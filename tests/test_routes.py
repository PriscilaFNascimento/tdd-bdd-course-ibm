...
class TestProductRoutes(TestCase):
    ...
    def test_get_product_not_found(self):
        """It should return a not found error when trying to return a single Product"""
        response = self.client.get(f"{BASE_URL}/123456")
